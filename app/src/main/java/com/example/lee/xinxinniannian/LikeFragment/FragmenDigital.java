...
public class FragmenDigital extends android.support.v4.app.Fragment{
    View view;
    Context context;
    ...
    private void init(){
        ...
        Cursor cursor=sd.query("StarDB",null,"fenlei=?",new String[]{"DIGITAL NEWCESSITIES/数码"},null,null,null);
