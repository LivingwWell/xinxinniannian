...
public class FragmentCioth extends Fragment {
    View view;
    Context context;
    ...
    private void init(){
        ...
        Cursor cursor=sd.query("StarDB",null,"fenlei=?",new String[]{"CIOTH NEWCESSITIES/衣物"},null,null,null);
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fargment_cioth, container, false);
        init();
