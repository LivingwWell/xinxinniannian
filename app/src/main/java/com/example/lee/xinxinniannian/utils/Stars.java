...
public class Stars extends SQLiteOpenHelper{
  public Stars(Context context){
    ...
    public void onCreate(SQLiteDatabase db) {
      db.execSQL("create table StarDB(id integer primary key autoincrement,imagerUrl varchar(100),webUrl varchar(100),fenlei varchar(20))");
    }
/**
 * 当数据库更新的时候调用的方法
 ...
 */
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
           db.execSQL("alter table StarDB add account varchar(20)");
    }
}
